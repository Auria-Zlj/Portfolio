...
const projects = [
    {
        ...
        description: 'Built an AI-assisted system for faster salmon origin identification.',
        tags: ['Decision Architecture', 'Human-in-the-Loop AI'],
        sponsor: '',
        highlights: ['Reduced turnaround from days to near-immediate', 'Deployed internally at Washington DFW'],
        thumbnails: [],
        thumbnailLabels: [],
